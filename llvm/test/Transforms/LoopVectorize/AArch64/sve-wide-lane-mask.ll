...
; CHECK-UF4-NEXT:    [[TMP32:%.*]] = mul nuw i64 [[TMP1]], 2
; CHECK-UF4-NEXT:    [[TMP33:%.*]] = getelementptr inbounds i8, ptr [[TMP20]], i64 [[TMP32]]
; CHECK-UF4-NEXT:    [[TMP29:%.*]] = mul nuw i64 [[TMP1]], 3
...
; CHECK-UF4-NEXT:    [[TMP41:%.*]] = mul nuw i64 [[TMP1]], 2
; CHECK-UF4-NEXT:    [[TMP42:%.*]] = getelementptr inbounds i8, ptr [[TMP35]], i64 [[TMP41]]
; CHECK-UF4-NEXT:    [[TMP44:%.*]] = mul nuw i64 [[TMP1]], 3
...
; CHECK-UF4-NEXT:    [[TMP21:%.*]] = mul nuw i64 [[TMP1]], 2
; CHECK-UF4-NEXT:    [[TMP22:%.*]] = getelementptr inbounds double, ptr [[TMP15]], i64 [[TMP21]]
; CHECK-UF4-NEXT:    [[TMP24:%.*]] = mul nuw i64 [[TMP1]], 3
...
; CHECK-UF4-NEXT:    [[TMP36:%.*]] = mul nuw i64 [[TMP1]], 2
; CHECK-UF4-NEXT:    [[TMP37:%.*]] = getelementptr inbounds double, ptr [[TMP30]], i64 [[TMP36]]
; CHECK-UF4-NEXT:    [[TMP39:%.*]] = mul nuw i64 [[TMP1]], 3
