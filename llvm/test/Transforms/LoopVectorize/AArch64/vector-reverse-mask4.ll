...
; CHECK-NEXT:    [[TMP16:%.*]] = getelementptr inbounds double, ptr [[COND]], i64 [[TMP15]]
; CHECK-NEXT:    [[TMP3:%.*]] = getelementptr inbounds i8, ptr [[TMP2]], i64 -24
; CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds i8, ptr [[TMP16]], i64 -56
...
; CHECK-NEXT:    [[TMP17:%.*]] = getelementptr double, ptr [[A]], i64 [[TMP15]]
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr i8, ptr [[TMP7]], i64 -24
; CHECK-NEXT:    [[TMP9:%.*]] = getelementptr i8, ptr [[TMP17]], i64 -56
