...
; VF-TWO-CHECK-NEXT:    [[TMP8:%.*]] = add i32 [[OFFSET_IDX]], 4
; VF-TWO-CHECK-NEXT:    [[TMP9:%.*]] = add i32 [[OFFSET_IDX]], 8
; VF-TWO-CHECK-NEXT:    [[TMP10:%.*]] = add i32 [[OFFSET_IDX]], 12
; VF-TWO-CHECK-NEXT:    [[TMP11:%.*]] = add i32 [[OFFSET_IDX]], 16
; VF-TWO-CHECK-NEXT:    [[TMP12:%.*]] = add i32 [[OFFSET_IDX]], 20
; VF-TWO-CHECK-NEXT:    [[TMP13:%.*]] = add i32 [[OFFSET_IDX]], 24
; VF-TWO-CHECK-NEXT:    [[TMP14:%.*]] = add i32 [[OFFSET_IDX]], 28
; VF-TWO-CHECK-NEXT:    [[TMP24:%.*]] = xor i32 [[OFFSET_IDX]], -1
; VF-TWO-CHECK-NEXT:    [[TMP16:%.*]] = xor i32 [[TMP8]], -1
; VF-TWO-CHECK-NEXT:    [[TMP17:%.*]] = xor i32 [[TMP9]], -1
...
; VF-TWO-CHECK-NEXT:    [[TMP31:%.*]] = add i32 [[TMP16]], [[N]]
; VF-TWO-CHECK-NEXT:    [[TMP25:%.*]] = add i32 [[TMP17]], [[N]]
...
; VF-TWO-CHECK-NEXT:    [[TMP33:%.*]] = sext i32 [[TMP25]] to i64
...
; VF-TWO-CHECK-NEXT:    [[TMP41:%.*]] = getelementptr inbounds float, ptr [[B]], i64 [[TMP33]]
...
; VF-TWO-CHECK-NEXT:    [[TMP45:%.*]] = getelementptr inbounds float, ptr [[B]], i64 [[TMP37]]
...
; VF-TWO-CHECK-NEXT:    [[TMP59:%.*]] = getelementptr inbounds float, ptr [[TMP47]], i64 -7
; VF-TWO-CHECK-NEXT:    [[TMP61:%.*]] = getelementptr inbounds float, ptr [[TMP41]], i64 -11
; VF-TWO-CHECK-NEXT:    [[TMP63:%.*]] = getelementptr inbounds float, ptr [[TMP42]], i64 -15
; VF-TWO-CHECK-NEXT:    [[TMP65:%.*]] = getelementptr inbounds float, ptr [[TMP43]], i64 -19
; VF-TWO-CHECK-NEXT:    [[TMP67:%.*]] = getelementptr inbounds float, ptr [[TMP44]], i64 -23
; VF-TWO-CHECK-NEXT:    [[TMP69:%.*]] = getelementptr inbounds float, ptr [[TMP45]], i64 -27
; VF-TWO-CHECK-NEXT:    [[TMP71:%.*]] = getelementptr inbounds float, ptr [[TMP46]], i64 -31
...
; VF-FOUR-CHECK-NEXT:    [[TMP8:%.*]] = add i32 [[OFFSET_IDX]], 4
; VF-FOUR-CHECK-NEXT:    [[TMP9:%.*]] = add i32 [[OFFSET_IDX]], 8
; VF-FOUR-CHECK-NEXT:    [[TMP10:%.*]] = add i32 [[OFFSET_IDX]], 12
; VF-FOUR-CHECK-NEXT:    [[TMP11:%.*]] = add i32 [[OFFSET_IDX]], 16
; VF-FOUR-CHECK-NEXT:    [[TMP12:%.*]] = add i32 [[OFFSET_IDX]], 20
; VF-FOUR-CHECK-NEXT:    [[TMP13:%.*]] = add i32 [[OFFSET_IDX]], 24
; VF-FOUR-CHECK-NEXT:    [[TMP14:%.*]] = add i32 [[OFFSET_IDX]], 28
; VF-FOUR-CHECK-NEXT:    [[TMP24:%.*]] = xor i32 [[OFFSET_IDX]], -1
; VF-FOUR-CHECK-NEXT:    [[TMP16:%.*]] = xor i32 [[TMP8]], -1
; VF-FOUR-CHECK-NEXT:    [[TMP17:%.*]] = xor i32 [[TMP9]], -1
...
; VF-FOUR-CHECK-NEXT:    [[TMP31:%.*]] = add i32 [[TMP16]], [[N]]
; VF-FOUR-CHECK-NEXT:    [[TMP25:%.*]] = add i32 [[TMP17]], [[N]]
...
; VF-FOUR-CHECK-NEXT:    [[TMP33:%.*]] = sext i32 [[TMP25]] to i64
...
; VF-FOUR-CHECK-NEXT:    [[TMP41:%.*]] = getelementptr inbounds float, ptr [[B]], i64 [[TMP33]]
...
; VF-FOUR-CHECK-NEXT:    [[TMP45:%.*]] = getelementptr inbounds float, ptr [[B]], i64 [[TMP37]]
...
; VF-FOUR-CHECK-NEXT:    [[TMP59:%.*]] = getelementptr inbounds float, ptr [[TMP47]], i64 -7
; VF-FOUR-CHECK-NEXT:    [[TMP61:%.*]] = getelementptr inbounds float, ptr [[TMP41]], i64 -11
; VF-FOUR-CHECK-NEXT:    [[TMP63:%.*]] = getelementptr inbounds float, ptr [[TMP42]], i64 -15
; VF-FOUR-CHECK-NEXT:    [[TMP65:%.*]] = getelementptr inbounds float, ptr [[TMP43]], i64 -19
; VF-FOUR-CHECK-NEXT:    [[TMP67:%.*]] = getelementptr inbounds float, ptr [[TMP44]], i64 -23
; VF-FOUR-CHECK-NEXT:    [[TMP69:%.*]] = getelementptr inbounds float, ptr [[TMP45]], i64 -27
; VF-FOUR-CHECK-NEXT:    [[TMP71:%.*]] = getelementptr inbounds float, ptr [[TMP46]], i64 -31
