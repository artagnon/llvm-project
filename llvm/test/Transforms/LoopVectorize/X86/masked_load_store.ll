...
; AVX2-NEXT:    [[TMP0:%.*]] = add i64 [[OFFSET_IDX]], -4
; AVX2-NEXT:    [[TMP3:%.*]] = add i64 [[OFFSET_IDX]], -8
; AVX2-NEXT:    [[TMP2:%.*]] = add i64 [[OFFSET_IDX]], -12
...
; AVX2-NEXT:    [[TMP8:%.*]] = getelementptr inbounds i32, ptr [[TMP4]], i64 -7
; AVX2-NEXT:    [[TMP9:%.*]] = getelementptr inbounds i32, ptr [[TMP7]], i64 -11
; AVX2-NEXT:    [[TMP31:%.*]] = getelementptr inbounds i32, ptr [[TMP6]], i64 -15
; AVX2-NEXT:    [[WIDE_LOAD:%.*]] = load <4 x i32>, ptr [[TMP5]], align 4, !alias.scope [[META22:![0-9]+]]
; AVX2-NEXT:    [[WIDE_LOAD6:%.*]] = load <4 x i32>, ptr [[TMP8]], align 4, !alias.scope [[META22]]
; AVX2-NEXT:    [[WIDE_LOAD8:%.*]] = load <4 x i32>, ptr [[TMP9]], align 4, !alias.scope [[META22]]
; AVX2-NEXT:    [[WIDE_LOAD10:%.*]] = load <4 x i32>, ptr [[TMP31]], align 4, !alias.scope [[META22]]
...
; AVX2-NEXT:    [[TMP16:%.*]] = getelementptr double, ptr [[IN]], i64 [[TMP0]]
; AVX2-NEXT:    [[TMP17:%.*]] = getelementptr double, ptr [[IN]], i64 [[TMP3]]
; AVX2-NEXT:    [[TMP18:%.*]] = getelementptr double, ptr [[IN]], i64 [[TMP2]]
; AVX2-NEXT:    [[TMP15:%.*]] = getelementptr double, ptr [[TMP14]], i64 -3
; AVX2-NEXT:    [[TMP20:%.*]] = getelementptr double, ptr [[TMP16]], i64 -7
; AVX2-NEXT:    [[TMP21:%.*]] = getelementptr double, ptr [[TMP17]], i64 -11
; AVX2-NEXT:    [[TMP22:%.*]] = getelementptr double, ptr [[TMP18]], i64 -15
...
; AVX2-NEXT:    [[WIDE_MASKED_LOAD14:%.*]] = call <4 x double> @llvm.masked.load.v4f64.p0(ptr align 8 [[TMP20]], <4 x i1> [[REVERSE13]], <4 x double> poison), !alias.scope [[META25]]
; AVX2-NEXT:    [[REVERSE15:%.*]] = shufflevector <4 x i1> [[TMP12]], <4 x i1> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
; AVX2-NEXT:    [[WIDE_MASKED_LOAD16:%.*]] = call <4 x double> @llvm.masked.load.v4f64.p0(ptr align 8 [[TMP21]], <4 x i1> [[REVERSE15]], <4 x double> poison), !alias.scope [[META25]]
...
; AVX2-NEXT:    [[TMP28:%.*]] = getelementptr double, ptr [[OUT]], i64 [[TMP0]]
; AVX2-NEXT:    [[TMP29:%.*]] = getelementptr double, ptr [[OUT]], i64 [[TMP3]]
; AVX2-NEXT:    [[TMP30:%.*]] = getelementptr double, ptr [[OUT]], i64 [[TMP2]]
; AVX2-NEXT:    [[TMP19:%.*]] = getelementptr double, ptr [[TMP27]], i64 -3
; AVX2-NEXT:    [[TMP32:%.*]] = getelementptr double, ptr [[TMP28]], i64 -7
; AVX2-NEXT:    [[TMP33:%.*]] = getelementptr double, ptr [[TMP29]], i64 -11
; AVX2-NEXT:    [[TMP34:%.*]] = getelementptr double, ptr [[TMP30]], i64 -15
...
; AVX2-NEXT:    call void @llvm.masked.store.v4f64.p0(<4 x double> [[REVERSE27]], ptr align 8 [[TMP32]], <4 x i1> [[REVERSE13]]), !alias.scope [[META27]], !noalias [[META29]]
...
; AVX512-NEXT:    [[TMP0:%.*]] = add i64 [[OFFSET_IDX]], -8
; AVX512-NEXT:    [[TMP3:%.*]] = add i64 [[OFFSET_IDX]], -16
; AVX512-NEXT:    [[TMP2:%.*]] = add i64 [[OFFSET_IDX]], -24
...
; AVX512-NEXT:    [[TMP8:%.*]] = getelementptr inbounds i32, ptr [[TMP4]], i64 -15
; AVX512-NEXT:    [[TMP9:%.*]] = getelementptr inbounds i32, ptr [[TMP7]], i64 -23
; AVX512-NEXT:    [[TMP31:%.*]] = getelementptr inbounds i32, ptr [[TMP6]], i64 -31
; AVX512-NEXT:    [[WIDE_LOAD:%.*]] = load <8 x i32>, ptr [[TMP5]], align 4, !alias.scope [[META34:![0-9]+]]
; AVX512-NEXT:    [[WIDE_LOAD6:%.*]] = load <8 x i32>, ptr [[TMP8]], align 4, !alias.scope [[META34]]
; AVX512-NEXT:    [[WIDE_LOAD7:%.*]] = load <8 x i32>, ptr [[TMP9]], align 4, !alias.scope [[META34]]
; AVX512-NEXT:    [[WIDE_LOAD8:%.*]] = load <8 x i32>, ptr [[TMP31]], align 4, !alias.scope [[META34]]
...
; AVX512-NEXT:    [[TMP16:%.*]] = getelementptr double, ptr [[IN]], i64 [[TMP0]]
; AVX512-NEXT:    [[TMP17:%.*]] = getelementptr double, ptr [[IN]], i64 [[TMP3]]
; AVX512-NEXT:    [[TMP18:%.*]] = getelementptr double, ptr [[IN]], i64 [[TMP2]]
; AVX512-NEXT:    [[TMP15:%.*]] = getelementptr double, ptr [[TMP14]], i64 -7
; AVX512-NEXT:    [[TMP20:%.*]] = getelementptr double, ptr [[TMP16]], i64 -15
; AVX512-NEXT:    [[TMP21:%.*]] = getelementptr double, ptr [[TMP17]], i64 -23
; AVX512-NEXT:    [[TMP22:%.*]] = getelementptr double, ptr [[TMP18]], i64 -31
...
; AVX512-NEXT:    [[WIDE_MASKED_LOAD14:%.*]] = call <8 x double> @llvm.masked.load.v8f64.p0(ptr align 8 [[TMP20]], <8 x i1> [[REVERSE13]], <8 x double> poison), !alias.scope [[META37]]
; AVX512-NEXT:    [[REVERSE15:%.*]] = shufflevector <8 x i1> [[TMP12]], <8 x i1> poison, <8 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
; AVX512-NEXT:    [[WIDE_MASKED_LOAD16:%.*]] = call <8 x double> @llvm.masked.load.v8f64.p0(ptr align 8 [[TMP21]], <8 x i1> [[REVERSE15]], <8 x double> poison), !alias.scope [[META37]]
...
; AVX512-NEXT:    [[TMP28:%.*]] = getelementptr double, ptr [[OUT]], i64 [[TMP0]]
; AVX512-NEXT:    [[TMP29:%.*]] = getelementptr double, ptr [[OUT]], i64 [[TMP3]]
; AVX512-NEXT:    [[TMP30:%.*]] = getelementptr double, ptr [[OUT]], i64 [[TMP2]]
; AVX512-NEXT:    [[TMP19:%.*]] = getelementptr double, ptr [[TMP27]], i64 -7
; AVX512-NEXT:    [[TMP32:%.*]] = getelementptr double, ptr [[TMP28]], i64 -15
; AVX512-NEXT:    [[TMP33:%.*]] = getelementptr double, ptr [[TMP29]], i64 -23
; AVX512-NEXT:    [[TMP34:%.*]] = getelementptr double, ptr [[TMP30]], i64 -31
...
; AVX512-NEXT:    call void @llvm.masked.store.v8f64.p0(<8 x double> [[REVERSE27]], ptr align 8 [[TMP32]], <8 x i1> [[REVERSE13]]), !alias.scope [[META39]], !noalias [[META41]]
